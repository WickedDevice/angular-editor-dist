...
import { Inject, Injectable, EventEmitter, forwardRef, HostListener, ViewChild, Output, HostBinding, Input, Component, Pipe, DOCUMENT as DOCUMENT$1, SecurityContext, ContentChild, Attribute, ViewEncapsulation, NgModule } from '@angular/core';
...
class ImageResizeService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: ImageResizeService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: ImageResizeService });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: ImageResizeService, decorators: [{
            type: Injectable
        }], ctorParameters: () => [] });
...
class AEButtonIsHiddenPipe {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: AEButtonIsHiddenPipe, deps: [], target: i0.ɵɵFactoryTarget.Pipe });
    static ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "20.3.13", ngImport: i0, type: AEButtonIsHiddenPipe, isStandalone: false, name: "buttonIsHidden" });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: AEButtonIsHiddenPipe, decorators: [{
            type: Pipe,
            args: [{
                    name: 'buttonIsHidden',
                    pure: true,
...
class AeToolbarComponent {
    ...
    markdownEmitter = new EventEmitter();
    myInputFile;
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: AeToolbarComponent, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i0.Renderer2 }, { type: AngularEditorService }, { type: i0.ElementRef }, { type: ImageResizeService }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [DOCUMENT$1]
                }] }], propDecorators: { id: [{
                type: Input
...
class AngularEditorComponent {
    ...
    exec() {
        ...
        if (this.doc.getSelection) {
            ...
            this.editorService.executeInNextQueueIteration(this.editorService.saveSelection); //.saveSelection).bind(this, this.textArea));?
        }
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: AngularEditorComponent, deps: [{ token: i0.Renderer2 }, { token: AngularEditorService }, { token: DOCUMENT$1 }, { token: i2.DomSanitizer }, { token: i0.ChangeDetectorRef }, { token: 'tabindex', attribute: true }, { token: 'autofocus', attribute: true }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.13", type: AngularEditorComponent, isStandalone: false, selector: "angular-editor", inputs: { id: "id", config: "config", placeholder: "placeholder", tabIndex: "tabIndex" }, outputs: { html: "html", markdownEmitter: "markdownEmitter", viewMode: "viewMode", blurEvent: "blur", focusEvent: "focus" }, host: { listeners: { "focus": "onFocus()" }, properties: { "attr.tabindex": "this.tabindex" } }, providers: [
            {
                provide: NG_VALUE_ACCESSOR,
