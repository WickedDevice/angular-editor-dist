(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@angular/common'), require('uuid'), require('@angular/forms'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('@kolkov/angular-editor', ['exports', '@angular/core', '@angular/common/http', '@angular/common', 'uuid', '@angular/forms', '@angular/platform-browser'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.kolkov = global.kolkov || {}, global.kolkov['angular-editor'] = {}), global.ng.core, global.ng.common.http, global.ng.common, global.uuid, global.ng.forms, global.ng.platformBrowser));
}(this, (function (exports, core, http, common, uuid, forms, platformBrowser) { 'use strict';
    ...
    var AngularEditorService = /** @class */ (function () {
        ...
        AngularEditorService.prototype.insertArbitraryHtml = function (html) {
    ...
    ImageResizeService.ctorParameters = function () { return []; };
    ...
    var AngularEditorComponent = /** @class */ (function () {
        function AngularEditorComponent(r, editorService, doc, sanitizer, cdRef, defaultTabIndex, autoFocus) {
            ...
            this.placeholder = '';
            this.markdownEmitter = new core.EventEmitter();
                    ...
                    providers: [
                        {
                            ...
                            useExisting: core.forwardRef(function () { return AngularEditorComponent; }),
                            multi: true
                        },
    ...
    ***************************************************************************** */
    ...
    var AEButtonIsHiddenPipe = /** @class */ (function () {
        function AEButtonIsHiddenPipe() {
        }
        AEButtonIsHiddenPipe.prototype.transform = function (name, hiddenButtons) {
            var e_1, _a;
            if (!name) {
                return false;
            }
            ...
            var result;
            try {
                for (var hiddenButtons_1 = __values(hiddenButtons), hiddenButtons_1_1 = hiddenButtons_1.next(); !hiddenButtons_1_1.done; hiddenButtons_1_1 = hiddenButtons_1.next()) {
                    var arr = hiddenButtons_1_1.value;
                ...
                try {
                    if (hiddenButtons_1_1 && !hiddenButtons_1_1.done && (_a = hiddenButtons_1.return)) _a.call(hiddenButtons_1);
                }
                finally { if (e_1) throw e_1.error; }
            }
            return result !== undefined;
        };
        return AEButtonIsHiddenPipe;
    }());
    ...
    var AngularEditorToolbarComponent = /** @class */ (function () {
        ...
        AngularEditorToolbarComponent.prototype.insertResource = function () {
    ...
    AngularEditorToolbarComponent.propDecorators = {
        ...
        insertResourceCallback: [{ type: core.Input }],
    ...
    AeSelectComponent.decorators = [
        { type: core.Component, args: [{
                    ...
                    providers: [
                        {
                            provide: forms.NG_VALUE_ACCESSOR,
                            useExisting: core.forwardRef(function () { return AeSelectComponent; }),
                            multi: true,
                        }
                    ],
    ...
    exports.AEButtonIsHiddenPipe = AEButtonIsHiddenPipe;
    ...
    exports.ɵa = ImageResizeService;
    exports.ɵb = AeSelectComponent;
